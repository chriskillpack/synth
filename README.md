...
- **Compressor**: Threshold/ratio dynamics compressor to tame clipping, with interactive transfer curve display
...
```
Oscillator + Harmonics ──▶ Low-pass Filter ──▶ Compressor ──▶ Amplifier ──▶ Output
                               ▲                                  ▲
